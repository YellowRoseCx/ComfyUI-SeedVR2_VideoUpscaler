...
class SeedVR2LoadDiTModel(io.ComfyNode):
        ...
        return io.Schema(
            ...
            inputs=[
                ...
                io.Combo.Input("attention_mode",
                    options=["sdpa", "flash_attn_2", "flash_attn_3", "sageattn_2", "sageattn_3", "sparse_sage", "sparge_attn"],
                    default="sdpa",
                    optional=True,
                    tooltip=(
    ...
    def execute(cls, model: str, device: str, offload_device: str = "none",
        ...
        Args:
            ...
            attention_mode: Attention computation backend ('sdpa', 'flash_attn_2', 'flash_attn_3', 'sageattn_2', 'sageattn_3', 'sparse_sage', or 'sparge_attn')
